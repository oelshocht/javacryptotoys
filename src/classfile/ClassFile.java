...
public class ClassFile
{
    ...
    private class Field
    {
        ...
        private static final int ACC_SYNTHETIC = 0x1000; // Declared synthetic; Not present in the source code.
        private static final int ACC_ENUM      = 0x4000; // Declared as an element of an enum.
        // Internal data.
        private int                       mIndex;
    ...
    private class Method
    {
        ...
        public String methodAccessFlags()
        {
            ...
            if (0 != (mAccessFlags & ACC_BRIDGE))
            {
                buffer.append("(bridge) ");
            }
            if (0 != (mAccessFlags & ACC_VARARGS))
            {
